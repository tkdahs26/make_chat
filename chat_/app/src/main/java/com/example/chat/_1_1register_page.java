...
public class _1_1register_page extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText nickname_edit = (EditText) findViewById(R.id.nickname_edit);
        ...
        joinbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (joinid_edit.getText().toString().isEmpty() || password_edit.getText().toString().isEmpty() || nickname_edit.getText().toString().isEmpty()) {
    ...
    public void onBackPressed() {
        ...
        public void send() {
            ...
            final String nickname_str = nickname_edit.getText().toString();
            ...
            StringRequest request = new StringRequest(
                ...
                public Map<String, String> getParams() {
                    ...
                    params.put("joinnickname",nickname_str);
